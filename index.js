...
// DB config
mongoose.connect("mongodb+srv://anirudh:anirudh@cluster0.jus8doq.mongodb.net/wealthup", {
    ...
    const checkCodeValidity = async (code) => {
        try {
            ...
            if (existingCode) {
                ...
                const timeDifferenceInMinutes = Math.floor((currentTime - codeTime) / (1000 * 60));
